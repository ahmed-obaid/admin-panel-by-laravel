                            ...
                            <div class="box-body table-responsive">
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach ($orders as $order)
                                        <tr>
                                            <td>{{ $order->client->name }}/{{ $order->client_id }} </td>
                                            ...
                                            <td style='width:250px'>
                                                ...
                                                @if (auth()->user()->hasPermission('update_orders'))
                                                    <a href=" {{ route('dashboard.orders.edit', ['order'=>$order->id ,'client'=>$order->client_id]) }} " class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> @lang('site.edit')</a>
                                                @else
